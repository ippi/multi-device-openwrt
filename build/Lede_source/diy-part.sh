...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='192.168.1.99'                      # IPv4 地址(openwrt后台地址)
ci set network.lan.netmask='255.255.255.0'                   # IPv4 子网掩码
...
uci set system.@system[0].hostname='OpenWrt-ippi'              # 修改主机名称为OpenWrt-123
